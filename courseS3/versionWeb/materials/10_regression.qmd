...
If you are interested in calculating robust standard errors, you can use the `estimatr` library. This topic is covered in these notes: [Robust standard errors](https://raw.githack.com/uo-ec607/lectures/master/08-regression/08-regression.html#Robust_standard_errors)"
...
The `performance` library also provides indices of model quality and goodness of fit.
...
Finally, the `margins` library also compute the marginal effects
