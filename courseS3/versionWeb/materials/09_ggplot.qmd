...
To plot a map, you require position information that links each observation to a specific location. This position can be represented as latitude and longitude (coordinate reference systems), special features (geometries), or raster data (regular grids)
