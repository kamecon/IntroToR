...
dtEs01 <- figarodt[REF_AREA == "ES" & COL_PI == "P3_S13", .(ROW_PI, COUNTERPART_AREA, COL_PI, OBS_VALUE)] |> 
  _[, .(P3_S13 = sum(OBS_VALUE)), by = ROW_PI]

dtEs02 <- figarodt[REF_AREA == "ES" & COL_PI == "P3_S14", .(ROW_PI, COUNTERPART_AREA, COL_PI, OBS_VALUE)] |> 
  _[, .(P3_S14 = sum(OBS_VALUE)), by = ROW_PI]

dtEsCompareTemp <- merge.data.table(x = dtEs01, y = dtEs02, by = "ROW_PI", all = TRUE)
...
<!--   unite(col = "IC_COL", REF_AREA, COL_PI, sep = "_", remove = FALSE) |>  -->
